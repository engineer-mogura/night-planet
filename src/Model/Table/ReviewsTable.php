...
class ReviewsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('atmosphere')
            ->requirePresence('atmosphere', 'create')
            ->notEmptyString('atmosphere');

        $validator
            ->integer('customer')
            ->requirePresence('customer', 'create')
            ->notEmptyString('customer');

        $validator
            ->integer('staff')
            ->requirePresence('staff', 'create')
            ->notEmptyString('staff');

        $validator
            ->integer('cleanliness')
            ->requirePresence('cleanliness', 'create')
            ->notEmptyString('cleanliness');
