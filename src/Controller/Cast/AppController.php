...
class AppController extends \App\Controller\AppController {
    ...
    public function isAuthorized($user) {
        ...
        // ログイン時に許可するアクション
        $access = [
            'index', 'favo', 'editCalendar', 'profile', 'saveProfile', 'topImage', 'saveTopImage', 'gallery', 'saveGallery', 'sns', 'deleteGallery', 'diary', 'saveDiary', 'viewDiary', 'deleteDiary', 'updateDiary', 'passChange'
        ];
