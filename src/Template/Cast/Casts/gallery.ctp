    ...
    <div class="container">
        <div class="row">
            <div id="gallery" class="col s12">
                ...
                <h5><?=('ギャラリー') ?></h5>
                <div class="row">
                    <form id="delete-gallery" name="delete_gallery" method="post" style="display:none;" action="/cast/casts/delete_gallery?id=<?=$castInfo['id']?>">
                        ...
                        <div class="col s6 m4 l3 card-img">
                            <div class="card">
                                <div class="card-image">
                                    ...
                                    <a class="btn-floating halfway-fab waves-effect waves-light red tooltipped deleteBtn" data-delete=<?=$image['simple_path']?> data-position="bottom" data-delay="50" data-tooltip="削除"><i class="material-icons">delete</i></a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
                <form id="save-gallery" name="save_gallery" method="post" accept-charset="utf-8" enctype="multipart/form-data" action="/cast/casts/save_gallery?id=<?=$castInfo['id']?>">
