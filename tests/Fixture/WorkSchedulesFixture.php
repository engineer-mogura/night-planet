...
class WorkSchedulesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cast_ids' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb3_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'shop_id' => 1,
                'cast_ids' => 'Lorem ipsum dolor sit amet',
                'created' => '2022-11-21 11:52:07',
                'modified' => '2022-11-21 11:52:07',
            ],
        ];
        parent::init();
    }
