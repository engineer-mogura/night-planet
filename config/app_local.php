...
*/
    ...
    // 'EmailTransport' => [
    //     'default' => [
    //         'className' => env('EMAIL_TRANSPORT_DEFAULT_CLASS_NAME', null),
    ...
    //         'client'    => null,
    //         'secure'    => env('EMAIL_TRANSPORT_DEFAULT_SSL', null),
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'username'  => env('EMAIL_TRANSPORT_DEFAULT_USERNAME', null),
            'password'  => env('EMAIL_TRANSPORT_DEFAULT_PASSWORD', null),
            'transport' => env('EMAIL_TRANSPORT_DEFAULT_TRANSPORT', 'Smtp'),
            'client'    => null,
            'secure'    => env('EMAIL_TRANSPORT_DEFAULT_SSL', null),
            'tls'       => env('EMAIL_TRANSPORT_DEFAULT_TLS', null),
            'url'       => env('EMAIL_TRANSPORT_DEFAULT_URL', null),
    ...
    'Datasources' => [
        'default' => [
            ...
            'timezone' => 'Asia/Tokyo',
            /**
             * TODO: エミュレータモードをon/offにした時のパフォーマンスを計測して下さっていますが、onにするとデータベースへの通信回数が減らせるので、確かに高速に動作しています。ただこの設定をon(true)にすると、取得結果の型情報が失われてしまう模様。
             * https://qiita.com/machio77777/items/20eae7bb16bec553d0a3
             */
            ...
            // MySql8に合わせて、ONLY_FULL_GROUP_BY エラー回避のため、除外する
            'init' => ["SET sql_mode = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION'"],
